...
#### ✒️ **作业站** 💖船新版本锐意测试ing~
- 浏览器输入【 share.maayuan.top 】，一键开抄！
- 目前功能：
 - 支持关卡、作者、密探、星盘、攻击力血量 等，筛选适合的作业
 - 一键复制作业并做个性化修改
 - 全新作业编辑器（基于司命 API 进行二次开发）
 - 支持动作链视图、类表格视图查看
 - 支持神秘代码分享（MaaYuan 可快速下载作业并使用）
 - 多格式兼容：已支持司命格式、Excel 表格、神秘代码、辟雍学府 等一键导入
...
- 可选 【处理叹号事件】、【交易条件】、【突破素材敌人】、【自动补兵】、【指定出战队伍】、【行动力未耗尽时行为】
- 新增 [boss 战也能全开自动打的流程攻略网页](http://zhaoge.maayuan.top)（适用于袁基、左慈、傅融线，分线后 56 回合通关），分步跟打，自动记录攻略进度
...
#### 🍖 **魂生一串**
  ...
  - 支持自动导航，仅适配前五种食材，支持自动丢掉烤焦的、自动升级食堂、自动接管继续营业。
  - 已适配回滚弹窗
