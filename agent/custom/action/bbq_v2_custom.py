...
DRINK_SELECT_NODE = {"广陵山泉": "BBQv2_选择广陵山泉", "红蓼桃桃": "BBQv2_选择红蓼桃桃",  "荼蘼芒芒": "BBQv2_选择荼蘼芒芒",  "碧竹青青": "BBQv2_选择碧竹青青",  "朱栾幽幽": "BBQv2_选择朱栾幽幽",  "瑞杏": "BBQv2_选择瑞杏", "冷酷果汁": "BBQv2_选择冷酷果汁", "白梅芝芝": "BBQv2_选择白梅芝芝"}
DRINK_PRODUCT_NODE = {"广陵山泉": "BBQv2_成品广陵山泉", "红蓼桃桃": "BBQv2_成品红蓼桃桃","荼蘼芒芒": "BBQv2_成品荼蘼芒芒","碧竹青青": "BBQv2_成品碧竹青青","朱栾幽幽": "BBQv2_成品朱栾幽幽","瑞杏": "BBQv2_成品瑞杏", "冷酷果汁": "BBQv2_成品冷酷果汁", "白梅芝芝": "BBQv2_成品白梅芝芝"}

# 有 pipeline 模板节点的食物/饮料列表（默认值，运行时从参数动态生成）
FOOD_TEMPLATES = ["肉丸", "骨髓", "糍粑", "豆角", "海鲜", "巫彭","奶豆腐","白薯", "广陵山泉", "冷酷果汁", "红蓼桃桃","白梅芝芝","碧竹青青","朱栾幽幽","荼蘼芒芒","瑞杏"]
