...
GRILL_SLOTS_ROI = {
    ...
    "2-1": [303, 836, 95, 179],  "2-2": [398, 836, 95, 179],   "2-3": [493, 836, 95, 179],
}

# 客人餐盘 ROI [x, y, w, h] (交付/清理)
PLATE_ROI = {1: [137, 760, 6, 6], 2: [359, 763, 6, 6], 3: [760, 763, 7, 6]}

# 客人气泡 ROI [x, y, w, h] (扫描订单)
BUBBLE_ROI = {1: [68, 469, 202, 119], 2: [261, 470, 231, 126], 3: [498, 487, 200, 131]}
...
DRINK_SELECT_NODE = {"广陵山泉": "BBQv2_选择广陵山泉", "红蓼桃桃": "BBQv2_选择红蓼桃桃", "荼蘼芒芒": "BBQv2_选择荼蘼芒芒", "碧竹青青": "BBQv2_选择碧竹青青", "朱栾幽幽": "BBQv2_选择朱栾幽幽", "瑞杏": "BBQv2_选择瑞杏", "冷酷果汁": "BBQv2_选择冷酷果汁", "白梅芝芝": "BBQv2_选择白梅芝芝","瞒呐": "BBQv2_选择瞒呐", "兴霸客": "BBQv2_选择兴霸客"}
DRINK_PRODUCT_NODE = {"广陵山泉": "BBQv2_成品广陵山泉", "红蓼桃桃": "BBQv2_成品红蓼桃桃", "荼蘼芒芒": "BBQv2_成品荼蘼芒芒", "碧竹青青": "BBQv2_成品碧竹青青", "朱栾幽幽": "BBQv2_成品朱栾幽幽", "瑞杏": "BBQv2_成品瑞杏", "冷酷果汁": "BBQv2_成品冷酷果汁", "白梅芝芝": "BBQv2_成品白梅芝芝","瞒呐": "BBQv2_成品瞒呐", "兴霸客": "BBQv2_成品兴霸客"}

# 有 pipeline 模板节点的食物/饮料列表（默认值，运行时从参数动态生成）
FOOD_TEMPLATES = ["肉丸", "骨髓", "糍粑", "豆角", "海鲜", "巫彭","奶豆腐","白薯","菌子","羊肉串","鱼","卷饼","葱","广陵山泉", "冷酷果汁", "红蓼桃桃","白梅芝芝","碧竹青青","朱栾幽幽","荼蘼芒芒","瑞杏","瞒呐","兴霸客瞒呐"]

# 饮料位置编号到默认名称的映射
DRINK_POSITION_NAMES = {1: "广陵山泉", 2: "红蓼桃桃"}

# 食材位置编号到默认名称的映射 (BBQv2 食材)
POSITION_NAMES = {1: "肉丸", 2: "骨髓", 3: "糍粑", 4: "豆角", 5: "海鲜"}
...
DEFAULT_COOK_DURATIONS = {
    "肉丸": 4.0, "骨髓": 6.25, "糍粑": 3.0, "豆角": 2.0, "海鲜": 5.0, "巫彭": 5.9,"奶豆腐": 3.0, "白薯": 3.0, "菌子":3.0,"羊肉串":5.0,"鱼":4.0,"卷饼":5.0,"葱":2.0,
}
