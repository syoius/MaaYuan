...
FOOD_TEMPLATES = ["肉丸", "牛骨髓", "糍粑", "豆角", "海鲜", "巫彭","奶豆腐","白薯","菌子","羊肉串","鱼","卷饼","葱","梭子蟹","广陵山泉", "冷酷果汁", "红蓼桃桃","白梅芝芝","碧竹青青","朱栾幽幽","荼蘼芒芒","瑞杏","瞒呐","兴霸客"]
...
DEFAULT_COOK_DURATIONS = {
    "肉丸": 4.0, "牛骨髓": 6.25, "糍粑": 3.0, "豆角": 2.0, "海鲜": 5.0, "巫彭": 5.9,"奶豆腐": 3.0, "白薯": 3.0, "菌子":3.0,"羊肉串":5.0,"鱼":4.0,"卷饼":5.0,"葱":2.0,"梭子蟹":6.25
}
